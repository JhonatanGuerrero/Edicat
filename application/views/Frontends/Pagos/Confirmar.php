                                ...
                                <form id="form-confirmarPago">
                                    ...
                                    <div class="col-md-12">
                                        <div class="pull-right btn-toolbar list-toolbar">
                                            <button id="btn-confirmarPago" name="btn-confirmarPago" class="btn btn-primary"><i class="fa fa-check"></i> Confirmar Pago</button>                                            
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        if (pag_cob.toString().length <= 0) {
                                            ...
                                            if (pag_obs.toString().length <= 0) {
                                                ...
                                                $.ajax({
                                                    ...
                                                    beforeSend: function () {
                                                        $('#message').html("");
                                                        $('#btn-confirmarPago').html('<i class="fa fa-check"></i> Confirmando...');
                                                    },
                                                    success: function (data) {
                                                        $('#btn-confirmarPago').html('<i class="fa fa-check"></i> Confirmar Pago');
                                                        if (data == 1) {
                                                            $('#message').html(
