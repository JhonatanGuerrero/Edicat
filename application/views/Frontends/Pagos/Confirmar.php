                            ...
                            <form id="form-confirmarPago">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="<?= $dataPago[0]["Cuota"]; ?>" class="form-control"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" class="form-control datepicker8" id="FechaPago"
                                            name="FechaPago">
                                    </div>
                                </div>
                                ...
                                if (pag_cob.toString().length <= 0) {
                                    ...
                                    if (pag_obs.toString().length <= 0) {
                                        ...
                                        $.ajax({
                                            ...
                                            beforeSend: function() {
                                                $('#message').html("");
                                                $('#btn-confirmarPago').attr('disabled',
                                                    'disabled');
