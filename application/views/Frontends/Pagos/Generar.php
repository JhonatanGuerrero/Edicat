                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= $ListaDatos2[0]["Nombre"]; ?>" class="form-control"
                                    id="cli_nom" name="cli_nom" disabled style="background-color: #ffffff;">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                    ...
                    <div class="col-md-10 col-md-offset-1">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    value="<?= money_format("%.0n", $ListaDatos3[$item["Codigo"]]["saldo"]); ?>"
                                    class="form-control" disabled style="background-color: #ffffff;"
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text"
                                    value="<?= money_format("%.0n", $ListaDatos3[$item["Codigo"]]["UltimoPago"]); ?>"
                                    class="form-control" disabled style="background-color: #ffffff;">
                            </div>
                        </div>
                        <div class="col-md-3">
                            ...
                            <form id="form-programaPago">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="" class="form-control" min="1"
                                            max="<?= $ListaDatos3[$item["Codigo"]]["saldo"]; ?>"
                                            id="NuevoAbono_<?= $item["Codigo"]; ?>"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" class="form-control" disabled
                                            style="background-color: #ffffff;" id="NuevoSaldo_<?= $item["Codigo"]; ?>"
                                            name="NuevoSaldo_<?= $item["Codigo"]; ?>">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" class="form-control datepicker8"
                                            id="FechaPrograma_<?= $item["Codigo"]; ?>"
                                            name="FechaPrograma_<?= $item["Codigo"]; ?>">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                    ...
                                    <div class="pull-right btn-toolbar list-toolbar">
                                        <button id="btn-programaPago-<?= $item["Codigo"]; ?>"
                                            name="btn-programaPago-<?= $item["Codigo"]; ?>" class="btn btn-primary"><i
                                                class="fa fa-save"></i> Programar Pago</button>
                                    </div>
                                </div>
                                <?php
                                    }
                        ...
                        if (pag_fec.toString().length <= 0) {
                            ...
                            if (pag_obs.toString().length <= 0) {
                                ...
                                $.ajax({
                                    ...
                                    beforeSend: function() {
                                        $('#message').html("");
                                        $('#btn-programaPago-<?= $item["Codigo"]; ?>').html(
                                            '<i class="fa fa-save"></i> Programando...');
                                        $('#btn-programaPago-<?= $item["Codigo"]; ?>').attr(
                                            'disabled', 'disabled');
                                    },
                                    success: function(data) {
                                        $('#btn-programaPago-<?= $item["Codigo"]; ?>').html(
                                            '<i class="fa fa-save"></i> Programar Pago');
                                        $('#btn-programaPago-<?= $item["Codigo"]; ?>').prop(
                                            "disabled", false);
                                        if (data == 1) {
                                            $('#message').html(
                                                ...
                                                .NumberFormat("es-CO").format(pag_pag) +
                                                '</b> para el día ' + pag_fec + '</strong>\n\
                                                            </div>');
                                            location.href =
                                                "<?= base_url("Pagos/Programados/"); ?>" + pag_ped +
                                                "/";
                                        } else {
                                            $('#message').html(
                                                '<div class="alert alert-danger alert-dismissable fade in">\n\
