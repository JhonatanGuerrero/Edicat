    ...
    <div class="main-content">
                        ...
                        <form id="form-FiltrarPagos" name="form-FiltrarPagos" method="POST">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="FechaIni" name="FechaIni" class="form-control datepicker1"
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="FechaFin" name="FechaFin" class="form-control datepicker1"
                                        required style="background-color: #ffffff;">
                                </div>
                            </div>
                            <div class="col-md-2">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <div class="btn-toolbar list-toolbar">
                                    ...
                                    <a href="#ModalPrint" data-toggle="modal" title="Imprimir Recibos"
                                        class="btn btn-info"><i class="fa fa-print"></i> Imprimir Recibos</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-content">
                    <form method="POST" name="form-modal" id="form-modal">
                        ...
                        <div class="modal-body">
                            <div class="row hidden">
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <label>Codigo</label>
                                        <input type="text" id="modal-codigo-confirmar" name="modal-codigo-confirmar"
                            ...
                            <div class="row">
                                <div class="col-md-6 hidden">
                                    <div class="form-group">
                                        <label>Pedido</label>
                                        <input type="text" id="modal-pedido-confirmar" name="modal-pedido-confirmar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6 hidden">
                                    <div class="form-group">
                                        <label>Cliente</label>
                                        <input type="text" id="modal-cliente-confirmar" name="modal-cliente-confirmar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input type="text" id="modal-nombre-confirmar" name="modal-nombre-confirmar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Recibo de Pago</label>
                                        <input type="text" id="modal-Pago-confirmar1" name="modal-Pago-confirmar1"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="modal-Saldo-confirmar1" name="modal-Saldo-confirmar1"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-12 hidden">
                                    <div class="form-group">
                                        <label>Valor</label>
                                        <input type="number" id="modal-Valor-confirmar" name="modal-Valor-confirmar"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="modal-Pago-confirmar" name="modal-Valor-confirmar"
                                            class="form-control" style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="modal-Saldo-confirmar" name="modal-Saldo-confirmar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="Cobrador-confirmar" id="Cobrador-confirmar"
                            ...
                            <div class="row">
                                <div class="col-md-12 hidden">
                                    <div class="form-group">
                                        ...
                                        <textarea value="" rows="6" class="form-control"
                                            name="ObservacionesAnt-confirmar" id="ObservacionesAnt-confirmar"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea value="" rows="3" class="form-control" name="Observaciones-confirmar"
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="error-text" style="margin-top:5px;">
                                        <i class="fa fa-check modal-icon" style="margin-top:-10px;"></i>¿Desea Confirmar
                                        este Pago?
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer" style="margin-top: -15px;">
                            <button class="btn btn-default" id="btn-modal-cerrar-confirmar"
                                name="btn-modal-cerrar-confirmar" data-dismiss="modal"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="POST" name="form-modal" id="form-modal">
                        ...
                        <div class="modal-body">
                            <div class="row ">
                                <div class="col-md-6 hidden">
                                    <div class="form-group">
                                        <label>Codigo</label>
                                        <input type="text" id="modal-codigo-descartar" name="modal-codigo-descartar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 hidden">
                                    <div class="form-group">
                                        <label>Pedido</label>
                                        <input type="text" id="modal-pedido-descartar" name="modal-pedido-descartar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6 hidden">
                                    <div class="form-group">
                                        <label>Cliente</label>
                                        <input type="text" id="modal-cliente-descartar" name="modal-cliente-descartar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input type="text" id="modal-nombre-descartar" name="modal-nombre-descartar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Pago</label>
                                        <input type="text" id="modal-Pago-descartar" name="modal-Pago-descartar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Saldo:</label>
                                        <input type="text" id="modal-saldo-descartar" name="modal-saldo-descartar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-12 hidden">
                                    <div class="form-group">
                                        <label>Valor</label>
                                        <input type="text" id="modal-Valor-descartar" name="modal-Valor-descartar"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6 hidden">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="Fecha-volverLlamar-descartar" readonly
                                            name="Fecha-volverLlamar-descartar" class="form-control datepicker8">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 hidden">
                                    <div class="form-group">
                                        <label>Observaciones Anteriores</label>
                                        <textarea value="" rows="6" class="form-control"
                                            name="ObservacionesAnt-descartar" id="ObservacionesAnt-descartar"
                                            style="resize: none;"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="error-text" style="margin-top:5px;">
                                        <i class="fa fa-check modal-icon" style="margin-top:-10px;"></i>¿Desea Descartar
                                        este Pago?
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer" style="margin-top: -15px;">
                            <button class="btn btn-default" id="btn-modal-cerrar-descartar"
                                name="btn-modal-cerrar-descartar" data-dismiss="modal"
                                aria-hidden="true">Cerrar</button>
                ...
                <div class="modal-content">
                    <form method="POST" name="form-modal" id="form-modal">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <p class="error-text"><i class="fa fa-warning modal-icon"></i>¿Desea imprimir estos
                                        recibos de pago en este momento?</p>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                        ...
                        <div class="modal-footer" style="margin-top: -15px;">
                            <button class="btn btn-default" id="btn-modal-cerrar" name="btn-modal-cerrar"
                                data-dismiss="modal" aria-hidden="true">Cerrar</button>
                            <button id="btn-modal" name="btn-modal" class="btn btn-info"><i class="fa fa-print"></i>
                                Imprimir Recibos</button>
                        </div>
                    </form>
                </div>
            </div>
                ...
                <div class="modal-content">
                    <form method="POST" name="form-modal" id="form-modal">
                        ...
                        <div class="modal-body">
                            <div class="row hidden">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Pedido</label>
                                        <input type="text" id="modal-PedidoSolo" name="modal-PedidoSolo"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Cliente</label>
                                        <input type="text" id="modal-ClienteSolo" name="modal-ClienteSolo"
                                            class="form-control" readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Número de Recibos</label>
                                        <input type="text" id="modal-numSolo" name="modal-numSolo" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Total de Pagos</label>
                                        <input type="text" id="modal-pagSolo" name="modal-pagSolo" class="form-control"
                                            readonly style="background-color:#ffffff;">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="modal-footer" style="margin-top: -15px;">
                            <button class="btn btn-default" id="btn-modal-cerrar" name="btn-modal-cerrar"
                                data-dismiss="modal" aria-hidden="true">Cerrar</button>
                            <button id="btn-modalSolo" name="btn-modalSolo" class="btn btn-info"><i
                                    class="fa fa-print"></i> Imprimir Recibo</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        $(document).ready(function() {
            ...
            $('#modal-Pago-confirmar').focusout(function() {
                ...
                pagoActual = pagoActual.replace("$", '').replace("", '').replace(".", '').replace(",",
                    '').trim();
                saldoActual = saldoActual.replace("$", '').replace("", '').replace(".", '').replace(",",
                    '').trim();
            ...
            $('#Observaciones-confirmar').focus(function() {
                ...
                if (abono.toString().length > 0 && fechaPago.toString().length > 0) {
                    ...
                    $('#Observaciones-confirmar').val(ob);
                } else {
                    $('#Observaciones-confirmar').val("");
                }
                $('#Observaciones-confirmar').blur();
            });
        });
        ...
        function listar() {
            $('#<?= $Controller; ?>').DataTable({
                ...
                ajax: {
                    method: 'post',
                    url: "<?= base_url(); ?>Pagos/pagosProgramados/"
                },
                language: {
        ...
        function dataModalConfirmar(codigo, pago, saldo, valor, cliente, pedido, nombre, observaciones) {
