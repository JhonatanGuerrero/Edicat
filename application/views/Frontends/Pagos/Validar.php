                        ...
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= money_format("%.0n", $ListaDatos3[$item["CodPedido"]]["saldo"]); ?>" class="form-control" disabled style="background-color: #ffffff;" id="SaldoActual_<?= $item["Codigo"]; ?>" name="SaldoActual_<?= $item["Codigo"]; ?>">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>Cuotas</label>
                                    <input type="text" value="<?= intval($ListaDatos3[$item["CodPedido"]]["cuota"]); ?>" class="form-control" disabled style="background-color: #ffffff;">
                                </div> 
                            </div> 
                            <div class="col-md-3">
                                <div class="form-group">
                                ...
                                <form id="form-programaPago">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?= money_format("%.0n", $dataPago[0]["Cuota"]); ?>" class="form-control" max="<?= $ListaDatos3[$item["CodPedido"]]["saldo"]; ?>" id="NuevoAbono_<?= $item["CodPedido"]; ?>" name="NuevoAbono_<?= $item["Codigo"]; ?>" onchange="saldo(<?= $item["Codigo"]; ?>, document.getElementById('SaldoActual_<?= $item["Codigo"]; ?>').value, this.value);" disabled style="background-color: #ffffff;">
                                        </div>
                                    </div> 
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Fecha de Recibo:</label>
                                            <input type="text" value="<?= date("d/m/Y", strtotime($dataPago[0]["FechaProgramada"])); ?>" class="form-control" id="FechaPrograma_<?= $item["Codigo"]; ?>" name="FechaPrograma_<?= $item["Codigo"]; ?>" disabled style="background-color: #ffffff;">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label>Notas/Observaciones</label>
                                            <textarea value="" rows="6" class="form-control" style="resize: none;" id="Observacion_<?= $item["Codigo"]; ?>" name="Observacion_<?= $item["Codigo"]; ?>" disabled><?= $dataPago[0]["Observaciones"]; ?></textarea>
                                        </div>  
                                    </div> 
                                    <div class="col-md-12">
                                        <div class="pull-right btn-toolbar list-toolbar">
                                            ...
                                            if ($item["Estado"] == 114) {
                                                ?>
                                                <a href="<?= base_url(); ?>Pagos/ProgramadosPaz/<?= $item["CodPedido"]; ?>/" id="btn-programaPago-<?= $item["Codigo"]; ?>" name="btn-programaPago-<?= $item["Codigo"]; ?>" class="btn btn-primary"><i class="fa fa-undo"></i> Pagos Programados</a>
                                                <?php
                                            } else {
                                                ?>
                                                <a href="<?= base_url(); ?>Pagos/Programados/<?= $item["CodPedido"]; ?>/" id="btn-programaPago-<?= $item["Codigo"]; ?>" name="btn-programaPago-<?= $item["Codigo"]; ?>" class="btn btn-primary"><i class="fa fa-undo"></i> Pagos Programados</a>
                                                <?php
                                            }
                                            ?>
                                        </div>
