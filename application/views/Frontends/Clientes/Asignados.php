...
<div class="content">
    ...
    <div class="main-content">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="selectNoEstados">Mostrar:</label>
                                        <select name="selectNoEstados" id="selectNoEstados" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="selectUsuarios" id="selectUsuarios" class="form-control">
                                            ...
                                            if ($Lista2 != false) {
                                                ...
                                                $UsuarioUsu = $this->session->userdata('Usuario');
                                                if ($CodigoUsu != '101') {
                                                    echo "<option value='" . $CodigoUsu . "'>" . $UsuarioUsu . "</option>";
                                                } else {
                            ...
                            <div class="col-md-10 col-md-offset-1" style="text-align: right;">
                                <div class="form-group">
                                    <br />
                                    <button id="btn-buscar" name="btn-buscar" class="btn btn-primary"><i
                                            class="fa fa-search"></i> Buscar Clientes</button>
        ...
        function buscar() {
            ...
            var selectNoEstados = $('#selectNoEstados').val();

            $("body").css({
                'cursor': 'wait'
            })

            listarFiltro(nombre, selectEstados, selectUsuarios, selectNoEstados);
        ...
        function listarFiltro(nombre, selectEstados, selectUsuarios, selectNoEstados) {
            $('#<?= $Controller; ?>').DataTable({
                bDestroy: true,
                responsive: true,
                scrollX: true,
                ...
                ajax: {
                    ...
                    data: {
                        ...
                        selectNoEstados: selectNoEstados
                    }
                },
                language: {
                    url: "<?= base_url('Public/assets/'); ?>/lib/Datetables.js/Spanish.json"
