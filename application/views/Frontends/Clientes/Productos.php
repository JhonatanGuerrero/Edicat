                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <a href="#" title="Eliminar Producto"
                                                onclick="alert('No se puede eliminar este producto.')"><i
                    ...
                    <div class="col-md-12">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Pedido</label>
                                <input type="text" value="<?= $pedido; ?>" class="form-control" readonly id="pedido"
                                    name="pedido">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="<?= $NombreCliente; ?>" class="form-control" readonly
                        ...
                        <form id="frm-AddProducto" name="frm-AddProducto">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" value="" class="form-control required" max="10" min="1"
                                        id="CantidadAddP" name="CantidadAddP">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="" class="form-control required" readonly id="ValorAddP"
                                        name="ValorAddP">
                                </div>
                            </div>
                            ...
                            <div class="col-md-12 text-right">
                                <div class="form-group">
                                    <button type="submit" class="btn btn-primary" name="btn-AddProducto"
                                        id="btn-AddProducto"><i class="fa fa-save"></i> Agregar Producto</button>
                                </div>
                            </div>
                    ...
                    success: function(html) {
                        if (html == 0) {
                            ...
                            $.each(html, function(key, value) {
                                $('#TarifaAddP').append("<option value='" + value.Codigo + "'>" +
                                    value.Nombre + "</option>");
                            });
                        }
                    }
                        ...
                        if (cantidad.toString().length <= 0) {
                            ...
                            if (valor.toString().length <= 0 || valor == 0) {
                                ...
                                $.ajax({
                                    ...
                                    beforeSend: function() {
                                        $('#message').html("");
                                        $('#btn-AddProducto').html(
                                            '<i class="fa fa-save"></i> Agregando Producto...');
                                    ...
                                    success: function(data) {
                                        ...
                                        if (data == 1) {
                                            $('#message').html(
                                                '<div class="alert alert-success alert-dismissable fade in">\n\
                                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>\n\
                                                            Se agregó el Producto <strong>' + $(
                                                    '#ProductoAddP option:selected').html() +
                                                '</strong> al Cliente <strong>' + nombre + '</strong>\n\
                                                        </div>');
