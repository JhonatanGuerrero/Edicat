                ...
                <div id="myTabContent" class="tab-content">
                    ...
                    <div class="tab-pane active in" id="datos">
                        <div class="form-group hidden">
                            <label>Pedido</label>
                            <input type="text" readonly style="background-color: #fff;" placeholder="Pedido"
                                value="<?= $pedido; ?>" class="form-control" id="pedido" name="pedido">
                        </div>
                        <div class="form-group hidden">
                            <label>Estado</label>
                            <input type="text" readonly style="background-color: #fff;" placeholder="Estado"
                                value="<?= $estado; ?>" class="form-control" id="estado" name="estado">
                        </div>
                        <form id="form-id">
                            <div class="form-group">
                                <label>Código Cliente</label>
                                <input type="text" readonly style="background-color: #fff;" placeholder="Codigo Cliente"
                                    value="<?= $Listadatos[0]["Codigo"]; ?>" class="form-control" id="Codigo"
                                    name="Codigo">
                            </div>
                            <div class="form-group">
                                <label>Nombre</label>
                                <input type="text" <?php if (!$accion) {
                        echo "readonly";
                    } ?> minlength="5" maxlength="50" style="background-color: #fff;" placeholder="Nombre"
                                    value="<?= $Listadatos[0]["Nombre"]; ?>" class="form-control" id="Nombre"
                                    name="Nombre">
                            </div>
                            <div class="form-group">
                                <label>Tipo de Documento</label>
                                <input type="text" readonly style="background-color: #fff;" placeholder="Tipo Documento"
                                    value="<?= $Lista1[0]['Nombre']; ?>" class="form-control required"
                                    id="TipoDocumento" name="TipoDocumento">
                            </div>
                            <div class="form-group">
                                <label>Documento</label>
                                <input type="number" <?php if (!$accion) {
                        echo "readonly";
                    } ?> style="background-color: #fff;" placeholder="Documento"
                                    value="<?= $Listadatos[0]["Documento"]; ?>" class="form-control number"
                                    id="Documento" name="Documento">
                            </div>
                            <div class="form-group pull-right <?php if (!$accion) {
                        echo "hidden";
                    } ?> ">
                                <button type="submit" id="btn-id" name="btn-id" class="btn btn-primary"><i
                                        class="fa fa-save"></i> Actualizar Datos</button>
                            </div>
                        </form>
                    </div>
                    <?php
                    ...
                    <div class="tab-pane fade" id="ubicacion">
                        <form id="form-ubicacion">
                            <div class="form-group">
                                ...
                                <input type="text" <?php if (!$accion) {
                        echo "readonly";
                    } ?> style="background-color: #fff;" placeholder="Direccion" value="<?= $Listadatos[0]["Dir"]; ?>"
                                    minlength="8" maxlength="150" class="form-control required" id="Direccion"
                                    name="Direccion">
                            </div>
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" <?php if (!$accion) {
                        echo "readonly";
                    } ?> style="background-color: #fff;" placeholder="Etapa" value="<?= $Listadatos[0]["Etapa"]; ?>"
                                            class="form-control" maxlength="10" id="Etapa" name="Etapa">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" <?php if (!$accion) {
                        echo "readonly";
                    } ?> style="background-color: #fff;" placeholder="Torre" value="<?= $Listadatos[0]["Torre"]; ?>"
                                            class="form-control" maxlength="10" id="Torre" name="Torre">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" <?php if (!$accion) {
                        echo "readonly";
                    } ?> style="background-color: #fff;" placeholder="Apartamento"
                                            value="<?= $Listadatos[0]["Apartamento"]; ?>" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" <?php if (!$accion) {
                        echo "readonly";
                    } ?> style="background-color: #fff;" placeholder="Manzana"
                                            value="<?= $Listadatos[0]["Manzana"]; ?>" class="form-control" id="Manzana"
                                            maxlength="10" name="Manzana">
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Conjunto - Interior</label>
                                        <input type="text" <?php if (!$accion) {
                        echo "readonly";
                    } ?> style="background-color: #fff;" placeholder="Conjunto - Interior"
                                            value="<?= $Listadatos[0]["Interior"]; ?>" class="form-control"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" <?php if (!$accion) {
                        echo "readonly";
                    } ?> style="background-color: #fff;" placeholder="Casa" value="<?= $Listadatos[0]["Casa"]; ?>"
                                            class="form-control" maxlength="10" id="Casa" name="Casa">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" <?php if (!$accion) {
                        echo "readonly";
                    } ?> style="background-color: #fff;" placeholder="Barrio" value="<?= $Listadatos[0]["Barrio"]; ?>"
                                            class="form-control required" maxlength="30" id="Barrio" name="Barrio">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Tipo de Vivienda *</label>
                                        <select name="TipoVivienda" <?php if (!$accion) {
                        echo "disabled = 'true'";
                                ...
                                <div class="form-group pull-right <?php if (!$accion) {
                                    ...
                                    <button type="submit" id="btn-ubicacion" name="btn-ubicacion"
                                        class="btn btn-primary"><i class="fa fa-save"></i> Actualizar Dirección</button>
                                </div>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="tab-pane fade" id="telefonos">
                        ...
                        <form id="form-telefonos">
                            <div class="form-group">
                                ...
                                <input type="text" <?php if (!$accion) {
                                                echo "readonly";
                                            } ?> style="background-color: #fff;" placeholder="Teléfono 1"
                                    value="<?= $Listadatos[0]["Telefono1"]; ?>" class="form-control required number"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" <?php if (!$accion) {
                                                echo "readonly";
                                            } ?> style="background-color: #fff;" placeholder="Teléfono 2"
                                    value="<?= $Listadatos[0]["Telefono2"]; ?>" class="form-control" minlength="7"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" <?php if (!$accion) {
                                                echo "readonly";
                                            } ?> style="background-color: #fff;" placeholder="Teléfono 3"
                                    value="<?= $Listadatos[0]["Telefono3"]; ?>" class="form-control" minlength="7"
                    ...
                    <div class="tab-pane fade" id="referencias">
                        ...
                        <form id="form-referencias">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        ?>" <?php if (!$accion) {
                                            echo "readonly";
                                        } ?> style="background-color: #fff;" class="form-control required"
                                            minlength="5" maxlength="50" id="NombreRef1" name="NombreRef1">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ?>" <?php if (!$accion) {
                                            ...
                                            minlength="7" maxlength="30" id="TelefonoRef1" name="TelefonoRef1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ?>" <?php if (!$accion) {
                                            ...
                                            minlength="3" maxlength="50" id="ParentescoRef1" name="ParentescoRef1">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group hidden">
                                        ...
                                        ?>" <?php if (!$accion) {
                                            echo "readonly";
                                        } ?> style="background-color: #fff;" class="form-control" id="CodigoRef2"
                                            name="CodigoRef2">
                                    </div>
                                    <div class="form-group">
                                        <label>Nombre Referencia *</label>
                                        ...
                                        ?>" <?php if (!$accion) {
                                            ...
                                            minlength="5" maxlength="50" id="NombreRef2" name="NombreRef2">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ?>" <?php if (!$accion) {
                                            ...
                                            minlength="7" maxlength="30" id="TelefonoRef2" name="TelefonoRef2">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ?>" <?php if (!$accion) {
                                            ...
                                            minlength="3" maxlength="10" id="ParentescoRef2" name="ParentescoRef2">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group hidden">
                                        ...
                                        ?>" <?php if (!$accion) {
                                            echo "readonly";
                                        } ?> style="background-color: #fff;" class="form-control" id="CodigoRef3"
                                            name="CodigoRef3">
                                    </div>
                                    <div class="form-group">
                                        <label>Nombre Referencia</label>
                                        ...
                                        ?>" <?php if (!$accion) {
                                            echo "readonly";
                                        } ?> style="background-color: #fff;" class="form-control" minlength="5"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ?>" <?php if (!$accion) {
                                            echo "readonly";
                                        } ?> style="background-color: #fff;" class="form-control" minlength="7"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        ?>" <?php if (!$accion) {
                                            echo "readonly";
                                        } ?> style="background-color: #fff;" class="form-control" minlength="3"
                                            maxlength="10" id="ParentescoRef3" name="ParentescoRef3">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group pull-right <?php if (!$accion) {
                                ...
                                <button type="submit" id="btn-referencias" name="btn-referencias"
                                    class="btn btn-primary"><i class="fa fa-save"></i> Actualizar Referencias</button>
                            </div>
                        </form>
                    </div>
                            ...
                            <div class="col-md-4 hidden">
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="Cantidad" value="<?= $cantidad; ?>" readonly
                                        style="background-color: #fff;" class="form-control" id="Cantidad1"
                                        name="Cantidad1">
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Valor Total"
                                        value="<?= money_format("%.0n", intval($item["Valor1"])); ?>" readonly
                                        style="background-color: #fff;" class="form-control" id="valorTotal1"
                                        name="valorTotal1">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Fecha Pedido"
                                        ...
                                        style="background-color: #fff;" class="form-control" id="FechaPedido"
                                        name="FechaPedido">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Tarifas" value="<?= $item["NomTarifa"]; ?>" readonly
                                        style="background-color: #fff;" class="form-control" id="Tarifa1"
                                        name="Tarifa1">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Valor del Descuento"
                                        value="<?= money_format("%.0n", $descuento); ?>" readonly
                                        style="background-color: #fff;" class="form-control required"
                                        id="valorDescuento" name="valorDescuento">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Fecha Pago"
                                        value="<?= date("d/m/Y", strtotime($item["DiaCobro"])); ?>" readonly
                                        style="background-color: #fff;" class="form-control" id="DiaCobro"
                                        name="DiaCobro">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="Cuotas" value="<?= $item["Cuotas"]; ?>" readonly
                                        style="background-color: #fff;" class="form-control required" id="numCuotas"
                                        name="numCuotas" onchange="tarifaManual(1)">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" min="0" placeholder="Valor de la Cuota"
                                        value="<?= money_format("%.0n", $ValorCuota); ?>" readonly
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" placeholder="Saldo"
                                        value="<?= money_format("%.0n", $item["Saldo"]); ?>" readonly
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group pull-right">
                                    <a href="<?= base_url("Clientes/Productos/" . $pedido . "/"); ?>"
                                        class="btn btn-primary"><i class="fa fa-shopping-basket"></i> Lista de
                                        Productos</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <form id="form-observaciones">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Vendedor" value="<?= $Lista5[0]["Nombre"]; ?>"
                                            readonly style="background-color: #fff;" class="form-control"
                                            name="Vendedor1" id="Vendedor1">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="usuarioAsignado" id="usuarioAsignado"
                                            ...
                                            <?php
                                        $idPermiso = 99;
                                        $accion2 = validarPermisoAcciones($idPermiso);
                                        if ($accion2) {
                                            ?>
                                            ...
                                            foreach ($ListaUsuarios as $item):
                                                $selectUser = "";
                                            if ($item['Codigo'] == $UsuarioAsignado) {
                                                $selectUser = "selected";
                                            }
                                                    
                                            echo '<option value="' . $item['Codigo'] . '" '. $selectUser .'>' . $item['Nombre'] . '</option>';
                                            endforeach; ?>
                                            <?php
                                        } else {
                                            foreach ($ListaUsuarios as $item):
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Iglesia" value="<?= $Lista6[0]["Iglesia"]; ?>"
                                            readonly style="background-color: #fff;" class="form-control" name="Iglesia"
                                            id="Iglesia">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Barrio" value="<?= $Lista6[0]["Barrio"]; ?>"
                                            readonly style="background-color: #fff;" class="form-control" name="Barrio"
                                            id="Barrio">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Fecha"
                                            value="<?= date("d/m/Y", strtotime($Lista6[0]["Fecha"])); ?>" readonly
                                            style="background-color: #fff;" class="form-control" name="Fecha"
                                            id="Fecha">
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="Ubicación Física" value="<?= $PaginaFisica; ?>" <?php if (!$accion) {
                                            echo "readonly";
                                        } ?> style="background-color: #fff;" class="form-control" name="Pagina"
                                            id="Pagina">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="6" disabled class="form-control" name="Observaciones"
                                            id="Observaciones"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="6" <?php if (!$accion) {
                                            echo "readonly";
                                        } ?> style="background-color: #fff;" class="form-control"
                                            name="nuevasObservaciones" id="nuevasObservaciones"
                            ...
                            <div class="col-md-12">
                                <div class="form-group pull-right <?php if (!$accion) {
                                    ...
                                    <button type="submit" id="btn-observaciones" name="btn-observaciones"
                                        class="btn btn-primary"><i class="fa fa-save"></i> Actualizar
    ...
    $(document).ready(function() {
                        ...
                        if (cli_tipviv.toString().length <= 0) {
                            ...
                            $.ajax({
                                ...
                                beforeSend: function() {
                                    $('#message').html("");
                                    $('#btn-ubicacion').html(
                                        '<i class="fa fa-save"></i> Actualizando...');
                                },
                                success: function(data) {
                                    $('#btn-ubicacion').html(
        ...
        function ActualizarTel() {
            ...
            if (cli_cod.toString().length <= 0) {
                ...
                if ((cli_tel1.toString().length <= 0) && (cli_tel2.toString().length <= 0) && (cli_tel3
                        .toString().length <= 0)) {
                    $('#message').html(
                        '<div class="alert alert-danger alert-dismissable fade in">\n\
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>\n\
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            $('#btn-ubicacion').html(
                                '<i class="fa fa-save"></i> Actualizar Teléfonos');
                            if (data == 1) {
                                $('#message').html(
                                    '<div class="alert alert-success alert-dismissable fade in">\n\
                                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>\n\
        ...
        function ActualizarRef() {
            ...
            if (cli_cod.toString().length <= 0) {
                ...
                if ((cli_nomrf1.toString().length <= 0) || (cli_telrf1.toString().length <= 0) || (cli_paren1
                        .toString().length <= 0)) {
                    $('#message').html(
                        '<div class="alert alert-danger alert-dismissable fade in">\n\
                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>\n\
                    ...
                    if ((cli_nomrf2.toString().length <= 0) || (cli_telrf2.toString().length <= 0) || (
                            cli_paren2.toString().length <= 0)) {
                        $('#message').html(
                            '<div class="alert alert-danger alert-dismissable fade in">\n\
                                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>\n\
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                $('#btn-ubicacion').html(
                                    '<i class="fa fa-save"></i> Actualizar Referencias');
                                if (data == 1) {
                                    $('#message').html(
                                        '<div class="alert alert-success alert-dismissable fade in">\n\
                                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>\n\
        ...
        function ActualizarObs() {
            ...
            var cli_usu = $('#usuarioAsignado').val();
            var cli_usu_nom = $('#usuarioAsignado option:selected').text();
                ...
                if (cli_pag.toString().length <= 0) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            cli_pag: cli_pag,
                            cli_usu: cli_usu,
                            cli_usu_nom: cli_usu_nom,
                            cli_obs: cli_obs
                        },
                        cache: false,
                        beforeSend: function() {
                            $('#message').html("");
                            $('#btn-observaciones').html(
                                '<i class="fa fa-save"></i> Actualizando...');
                        },
                        success: function(data) {
                            $('#btn-observaciones').html(
                                '<i class="fa fa-save"></i> Actualizar Observaciones');
                            if (data == 1) {
                                $('#message').html(
                                    '<div class="alert alert-success alert-dismissable fade in">\n\
                                                    <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>\n\
