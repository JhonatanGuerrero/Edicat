                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="btn-toolbar list-toolbar">
                            <a href="<?= base_url() . "Clientes/Admin/" ?>" class="btn btn-danger"><i
                                    class="fa fa-undo"></i> Volver a Clientes</a>
                        </div>
                    </div>
                </div>
                                ...
                                <div>
                                    ...
                                    <section style="margin-top:-15px;">
                                        <div class="form-group hidden">
                                            ...
                                            <input type="text" readonly placeholder="Orden de Pedido" value=""
                                                class="form-control" id="Orden" name="Orden">
                                        </div>
                                        <div class="form-group">
                                            <label>Nombre *</label>
                                            <input type="text" minlength="5" maxlength="50" placeholder="Nombre"
                                                value="" class="form-control required" id="Nombre" name="Nombre">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" min="0" placeholder="Documento" minlength="8"
                                                maxlength="15" value="" class="form-control required number"
                                    ...
                                    <section style="margin-top:-15px;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Direccion" value="" minlength="8"
                                                maxlength="150" class="form-control required" id="Direccion"
                                                name="Direccion">
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Etapa</label>
                                                    <input type="text" placeholder="Etapa" value="" class="form-control"
                                                        maxlength="10" id="Etapa" name="Etapa">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Torre</label>
                                                    <input type="text" placeholder="Torre" value="" class="form-control"
                                                        maxlength="10" id="Torre" name="Torre">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Apartamento</label>
                                                    <input type="text" placeholder="Apartamento" value=""
                                                        class="form-control" maxlength="10" id="Apartamento"
                                                        name="Apartamento">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Manzana</label>
                                                    <input type="text" placeholder="Manzana" value=""
                                                        class="form-control" id="Manzana" maxlength="10" name="Manzana">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Conjunto - Interior</label>
                                                    <input type="text" placeholder="Conjunto - Interior" value=""
                                                        class="form-control" maxlength="10" id="Interior"
                                                        name="Interior">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group">
                                                    <label>Casa</label>
                                                    <input type="text" placeholder="Casa" value="" class="form-control"
                                                        maxlength="10" id="Casa" name="Casa">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label>Barrio *</label>
                                                    <input type="text" placeholder="Barrio" value=""
                                                        class="form-control required" maxlength="30" id="Barrio"
                                                        name="Barrio">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                    ...
                                    <section style="margin-top:-15px;">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Teléfono 1" value=""
                                                class="form-control required number" minlength="7" maxlength="10"
                                                id="Telefono1" name="Telefono1">
                                        </div>
                                        <div class="form-group">
                                            <label>Teléfono 2</label>
                                            <input type="text" placeholder="Teléfono 2" value="" class="form-control"
                                                minlength="7" maxlength="10" id="Telefono2" name="Telefono2">
                                        </div>
                                        <div class="form-group">
                                            <label>Teléfono 3</label>
                                            <input type="text" placeholder="Teléfono 3" value="" class="form-control"
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Teléfono" value=""
                                                        class="form-control required" minlength="7" maxlength="30"
                                                        id="TelefonoRef1" name="TelefonoRef1">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Parentesco Referencia *</label>
                                                    <input type="text" placeholder="Parentesco" value=""
                                                        class="form-control required" minlength="3" maxlength="20"
                                                        id="ParentescoRef1" name="ParentescoRef1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Teléfono" value=""
                                                        class="form-control required" minlength="7" maxlength="30"
                                                        id="TelefonoRef2" name="TelefonoRef2">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Parentesco" value=""
                                                        class="form-control required" minlength="3" maxlength="20"
                                                        id="ParentescoRef2" name="ParentescoRef2">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Teléfono Referencia</label>
                                                    <input type="text" placeholder="Teléfono" value=""
                                                        class="form-control " minlength="7" maxlength="30"
                                                        id="TelefonoRef3" name="TelefonoRef3">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Parentesco" value=""
                                                        ...
                                                        id="ParentescoRef3" name="ParentescoRef3">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <h3>Productos </h3>
                                    <section style="margin-top:-15px;">
                                        <table class="table table-striped table-bordered" id="ProductosAdquiridos"
                                            style="width:100%;">
                                            <thead>
                                                <tr>
                                                    <th>Cantidad</th>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="number" min="0" placeholder="#"
                                                                onchange="valorProducto(1)" value=""
                                                                class="form-control required number" maxlength="3"
                                                                id="Cantidad1" name="Cantidad1">
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="form-group">
                                                            <select name="Producto1" id="Producto1"
                                                                onchange="valorProducto(1)"
                                                                class="form-control required">
                                                                <option value=""></option>
                                                                <?php
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <input type="number" min="0" placeholder="Valor"
                                                                style="background-color: #fff;" readonly value="0"
                                                                class="form-control required number" id="Valor1"
                                                                name="Valor1">
                                                        </div>
                                                    </td>
                                                </tr>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" placeholder="Valor Total" value=""
                                                        readonly style="background-color: #fff;"
                                                        class="form-control required" id="valorTotal1"
                                                        name="valorTotal1">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="Primer Cobro" value=""
                                                        class="form-control required datepicker" id="primerCobro"
                                                        name="primerCobro">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
...
//                                                        endforeach;
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" placeholder="Valor del Descuento"
                                                        value="0" readonly style="background-color: #fff;"
                                                        class="form-control required" id="valorDescuento"
                                                        name="valorDescuento">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" placeholder="Cuotas" value="" readonly
                                                        style="background-color: #fff;" class="form-control required"
                                                        id="numCuotas" name="numCuotas" onchange="tarifaManual(1)">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Valor de la Cuota *</label>
                                                    <input type="number" min="0" placeholder="Valor de la Cuota"
                                                        value="" readonly style="background-color: #fff;"
                                                        class="form-control required" id="valorCuota" name="valorCuota"
                                                        onchange="tarifaManual(2)">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Total a Pagar *</label>
                                                    <input type="number" placeholder="Total a Pagar" value=""
                                                        style="background-color: #fff;"
                                                        class="form-control required number" readonly id="TotalPagar"
                                                        name="TotalPagar">
                                                    <label name="lblErrorTotal" id="lblErrorTotal" class=""
                                                        style="color: #8a1f11;"></label>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>Abono</label>
                                                    <input type="number" placeholder="Abono" value="0" min="0"
                                                        class="form-control number" id="Abono" name="Abono">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="Vendedor1" id="Vendedor1"
                                                        class="form-control required">
                                                        <option disabled selected value>Vendedor</option>
                                                        <?php
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    if ($accion) {
                                                        ...
                                                        ?>
                                                        <option value="<?=  $this->session->userdata('Codigo'); ?>">
                                                            <?= $this->session->userdata('Nombre'); ?></option>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group ui-widget">
                                                    <label>Iglesia *</label>
                                                    <input type="text" id="IglesiaEvento" name="IglesiaEvento"
                                                        class="form-control required">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Barrio *</label>
                                                    <input type="text" id="BarrioEvento" name="BarrioEvento"
                                                        class="form-control required">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="PaginaEvento" name="PaginaEvento"
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea value="" rows="6" class="form-control"
    ...
    $(document).ready(function() {
        ...
        function crearcliente() {
            ...
            if (txtGuardando != '1') {
                ...
                var e_Usu = document.getElementById("usuarioAsignado");
                var cli_Usu = e_Usu.options[e_Usu.selectedIndex].value;
                        ...
                        success: function(data) {
                            ...
                            if (data == 1) {
                                $('#msgErrors').html(
                                    '<div class="alert alert-success alert-dismissable fade in">\n\
                                            <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>\n\
                                            <strong>El Cliente/Pedido \"<b>' +
                                    cli_nom +
                                    '</b>\" fue creado exitosamente</strong>\n\
                                         </div>'
                                );
                ...
                success: function(html) {
                    if (html == 0) {
                        ...
                        $.each(html, function(key, value) {
                            $('#Tarifa1').append("<option value='" + value.Codigo + "'>" + value
                                .Nombre + "</option>");
                        });
                    }
                }
    ...
    $(function() {
        ...
        $.each(iglesias, function(key, value) {
            resultIglesia.push(value);
        });

        var searchIglesia = $("#IglesiaEvento");
        searchIglesia.on('focus', function() {
            searchIglesia.autocomplete({
                source: resultIglesia
            });
        });
        ...
        $.each(eventos, function(key, value) {
            resultEvento.push(value);
        });

        var searchEvento = $("#BarrioEvento");
        searchEvento.on('focus', function() {
            searchEvento.autocomplete({
                source: resultEvento
            });
        });
