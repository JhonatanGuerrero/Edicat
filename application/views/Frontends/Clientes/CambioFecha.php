                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-md-offset-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" placeholder="Fecha Próximo"
                                                value="<?= date("d/m/Y", strtotime($item["DiaCobro"])); ?>"
                                                style="background-color: #fff;" class="form-control datepicker8"
                                        ...
                                        <div class="form-group pull-right">
                                            <button type="submit" id="btn-CambioFecha" name="btn-CambioFecha"
                ...
                if (cli_cli.toString().length <= 0) {
                    ...
                    if (cli_fec.toString().length <= 0) {
                        ...
                        $.ajax({
                            ...
                            beforeSend: function() {
                                $('#message').html("");
                                $('#btn-CambioFecha').html(
                                    '<i class="fa fa-save"></i> Cambiando Fecha de Pago...');
                            },
                            success: function(data) {
                                $('#btn-CambioFecha').html(
                                    '<i class="fa fa-save"></i> Cambio de Fecha');
                                if (data == 1) {
                                    $('#message').html(
                                    ...
                                    location.href = "<?= base_url("Pagos/Cliente/"); ?>" + cli_cli +
                                        "/";
                                } else {
                                    $('#message').html(
                                        '<div class="alert alert-danger alert-dismissable fade in">\n\
