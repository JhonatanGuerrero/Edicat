        ...
        <div class="panel-body">
            <form id="login" name="login" method="POST" role="form">
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-control span12 form-control" value="" id="passLogin"
                        name="passLogin">
                </div>
                <input type="submit" class="btn btn-lg btn-primary btn-block" id="btnLogin" name="btnLogin"
                    value="Iniciar" />
