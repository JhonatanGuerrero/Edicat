                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <div class="btn-toolbar list-toolbar">
                                <button id="btn-FiltrarNoLlamadas" name="btn-FiltrarNoLlamadas"
                                    class="btn btn-primary"><i class="fa fa-search"></i> Filtrar Fechas</button>
                            </div>
                        </div>
                    </div>
                </form>
                        ...
                        <div class="modal-body">
                            <div class="row hidden">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Llamada</label>
                                        <input type="text" id="modal-llamada" name="modal-llamada" class="form-control"
                                            readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" class="form-control" readonly id="modal-Telefono"
                                            name="modal-Telefono">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row hidden" id="divProLlamada">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" class="form-control datepicker8"
                                            id="FechaProgramada" name="FechaProgramada">
                                    </div>
                                </div>
                            </div>
                            <div class="row hidden" id="divProPago">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" value="" class="form-control datepicker10" id="FechaPago"
                                            name="FechaPago">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" value="" class="form-control" id="valorPago"
                                            name="valorPago">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea value="" rows="6" class="form-control" name="Observaciones"
                                            id="Observaciones" style="resize: none;"></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
