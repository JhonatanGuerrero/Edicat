...
<head>
    ...
    <link href="<?= base_url('Public'); ?>/assets/lib/font-awesome/css/font-awesome.css" rel="stylesheet"
        type="text/css">
    ...
    <link href="<?= base_url('Public'); ?>/assets/lib/Datetables.js/datatables.min.css" rel="stylesheet"
        type="text/css" />
    <link
        href="<?= base_url('Public'); ?>/assets/lib/bootstrap-datetimepicker/dist/css/bootstrap-datetimepicker.min.css"
        rel="stylesheet" />
    ...
    <script src="<?= base_url('Public'); ?>/assets/lib/jquery.mockjax.js" type="text/javascript"></script>
    <script src="<?= base_url('Public'); ?>/assets/lib/jquery.autocomplete.js" type="text/javascript"></script>
    ...
    <script
        src="<?= base_url('Public'); ?>/assets/lib/bootstrap-datetimepicker/dist/js/bootstrap-datetimepicker.min.js">
    </script>
    ...
    <script src="<?= base_url('Public'); ?>/assets/lib/formToWizard/jquery.steps.min.js" type="text/javascript">
    </script>
